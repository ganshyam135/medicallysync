...
export default function LivingRoomGallery() {
  const images = [
    {
      id: 1,
    ...
    },
    {
      ...
      description: "Elegant living room with premium furnishings"
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description: "Classic living room with timeless appeal"
    }
  ];
      ...
      <section className="bg-cream dark:bg-cream-dark py-20 md:py-28">
        <div className="container-custom">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-charcoal dark:text-charcoal-light">Living Room Designs</h1>
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Design the perfect gathering space with our living room designs that balance comfort, style, and functionality.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Living Room Designs?</h2>
            <p className="text-lg mb-8">
              Get in touch with us to create a custom living room design that brings your family together.
            </p>

...
export default function BedroomGallery() {
  const images = [
    ...
    },
    {
      ...
      title: "Kids Bedroom",
      description: "Playful and functional children's bedroom"
    },
    {
      id: 5,
      src: "https://images.unsplash.com/photo-1581539250439-c96689b516dd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Guest Bedroom",
      description: "Welcoming guest bedroom design"
    },
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Small Bedroom",
      description: "Space-efficient bedroom design"
    }
  ];
      ...
      <section className="bg-cream dark:bg-cream-dark py-20 md:py-28">
        <div className="container-custom">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-charcoal dark:text-charcoal-light">Bedroom Designs</h1>
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Create your perfect sanctuary with our elegant bedroom designs that combine comfort with sophisticated style.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Bedroom Designs?</h2>
            <p className="text-lg mb-8">
              Get in touch with us to create a custom bedroom design that ensures peaceful rest and comfort.
            </p>

  ...
  const images = [
    {
      ...
      description: "Contemporary dining space with sleek furniture"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Classic dining room with traditional elements"
    },
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Small Dining Space",
      description: "Compact dining area with smart storage"
    }
  ];
      ...
      <section className="bg-cream dark:bg-cream-dark py-20 md:py-28">
        <div className="container-custom">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-charcoal dark:text-charcoal-light">Dining Room Designs</h1>
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Create memorable dining experiences with our elegant dining room designs that bring family and friends together.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Dining Room Designs?</h2>
            <p className="text-lg mb-8">
              Get in touch with us to create a custom dining room design that makes every meal special.
            </p>
